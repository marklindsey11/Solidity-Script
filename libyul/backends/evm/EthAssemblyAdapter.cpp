...
AbstractAssembly::FunctionID EthAssemblyAdapter::registerFunction(uint8_t _args, uint8_t _rets, bool _canContinue)
{
	return m_assembly.createFunction(_args, _rets, _canContinue);
}
